...
- [ ] **T5 — Backend: guide module skeleton (DTO + service + module registration)**
...
- [ ] **T6 — Backend: `GET /api/guide/dashboard` controller**
...
- [ ] **T7 — Backend: unit tests for `GuideService`**
...
- [ ] **T8 — Backend: e2e coverage for all three endpoints**
