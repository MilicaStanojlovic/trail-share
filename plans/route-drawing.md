...
- [ ] **T1 — CreateRouteDto with lat/lng pair validator**
...
- [ ] **T3 — POST handler on RoutesController**
...
- [ ] **T4 — Unit tests: CreateRouteDto validation**
...
- [ ] **T5 — Unit tests: RoutesService.create**
...
- [ ] **T7 — Frontend port of route-stats**
...
- [ ] **T8 — Vitest + parity tests for the port**
...
- [ ] **T10 — publishRoute action on the routes store**
...
- [ ] **T11 — Draw screen: layout, draft state, live stats**
...
- [ ] **T12 — Draw screen: validation banner + publish flow**
