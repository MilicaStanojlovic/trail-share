...
export class Init1786903180541 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "routes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(120) NOT NULL, "description" text NOT NULL, "difficulty" "public"."routes_difficulty_enum" NOT NULL, "activity" "public"."routes_activity_enum" NOT NULL, "authorId" uuid NOT NULL, "waypoints" jsonb NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_76100511cdfa1d013c859f01d8b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tours" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "routeId" uuid NOT NULL, "guideId" uuid NOT NULL, "date" date NOT NULL, "startTime" TIME NOT NULL, "capacity" integer NOT NULL, "bookedCount" integer NOT NULL DEFAULT '0', "meetingPoint" character varying(200) NOT NULL, "pace" character varying(100) NOT NULL, "notes" text NOT NULL DEFAULT '', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2202ba445792c1ad0edf2de8de2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "bookings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tourId" uuid NOT NULL, "hikerId" uuid NOT NULL, "status" character varying(16) NOT NULL DEFAULT 'CONFIRMED', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_2f0d8fe10f7fb507f4559a15e90" UNIQUE ("tourId", "hikerId"), CONSTRAINT "PK_bee6805982cc1e248e94ce94957" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
