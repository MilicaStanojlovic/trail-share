...
- [ ] **T8 — Unit tests: AuthService and RolesGuard**
...
- [ ] **T9 — E2e spec: register → login → me + rejections**
...
- [ ] **T10 — Frontend auth types + Authorization header in the api client**
...
- [ ] **T13 — Router: /auth route and navigation guards**
...
- [ ] **T14 — Wire AppNav to the real user; sign-out flow**
