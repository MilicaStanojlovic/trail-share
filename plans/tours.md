...
- [ ] **T1 — Tour entity + ToursModule registration**
...
- [ ] **T2 — Seeder: the design's 5 tours**
...
- [ ] **T3 — DTOs: CreateTourDto + TourDto interfaces**
...
- [ ] **T6 — Controllers: ToursController + RouteToursController**
...
- [ ] **T10 — Tour types + date formatting helper**
...
- [ ] **T15 — ScheduleTourDialog component**
...
- [ ] **T16 — Route detail: tour list + schedule button wiring**
